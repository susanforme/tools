...
const formatterTools = [
  ...
  },
  {
    ...
    tagKeys: [
      'home.tools.html.tagFormat',
      'home.tools.html.tagMinify',
      'home.tools.html.tagAccessibility',
    ],
...
const developerExtraTools = [
  ...
  },
  {
    ...
    titleKey: 'communityNext.chromeCoverage.title',
    descKey: 'communityNext.chromeCoverage.desc',
    tagKeys: [],
    gradient: 'hover:bg-sky-50 dark:hover:bg-sky-950/20',
    border: 'hover:border-sky-300 dark:hover:border-sky-700',
  },
  {
    to: '/react-profiler' as const,
    icon: <Activity className="h-8 w-8 text-rose-500" />,
    titleKey: 'communityNext.reactProfiler.title',
    descKey: 'communityNext.reactProfiler.desc',
    tagKeys: [],
    gradient: 'hover:bg-rose-50 dark:hover:bg-rose-950/20',
    border: 'hover:border-rose-300 dark:hover:border-rose-700',
  },
  {
    ...
    titleKey: 'communityNext.pprof.title',
    descKey: 'communityNext.pprof.desc',
    tagKeys: [],
    gradient: 'hover:bg-amber-50 dark:hover:bg-amber-950/20',
    border: 'hover:border-amber-300 dark:hover:border-amber-700',
  },
  {
    to: '/prometheus' as const,
    icon: <Activity className="h-8 w-8 text-emerald-500" />,
    titleKey: 'communityNext.prometheus.title',
    descKey: 'communityNext.prometheus.desc',
    tagKeys: [],
    gradient: 'hover:bg-emerald-50 dark:hover:bg-emerald-950/20',
    border: 'hover:border-emerald-300 dark:hover:border-emerald-700',
  },
  {
    to: '/binary-data' as const,
    icon: <Activity className="h-8 w-8 text-violet-500" />,
    titleKey: 'communityNext.binaryData.title',
    descKey: 'communityNext.binaryData.desc',
    tagKeys: [],
    gradient: 'hover:bg-violet-50 dark:hover:bg-violet-950/20',
    border: 'hover:border-violet-300 dark:hover:border-violet-700',
  },
  {
    to: '/arrow-viewer' as const,
    icon: <Activity className="h-8 w-8 text-orange-500" />,
    titleKey: 'communityNext.arrowViewer.title',
    descKey: 'communityNext.arrowViewer.desc',
    tagKeys: [],
    gradient: 'hover:bg-orange-50 dark:hover:bg-orange-950/20',
    border: 'hover:border-orange-300 dark:hover:border-orange-700',
  },
  {
    to: '/hcl-inspector' as const,
    icon: <Activity className="h-8 w-8 text-cyan-500" />,
    titleKey: 'communityNext.hclInspector.title',
    descKey: 'communityNext.hclInspector.desc',
    tagKeys: [],
    gradient: 'hover:bg-cyan-50 dark:hover:bg-cyan-950/20',
    border: 'hover:border-cyan-300 dark:hover:border-cyan-700',
  },
  {
    to: '/openpgp' as const,
    icon: <Activity className="h-8 w-8 text-fuchsia-500" />,
    titleKey: 'communityNext.openpgp.title',
    descKey: 'communityNext.openpgp.desc',
    tagKeys: [],
    gradient: 'hover:bg-fuchsia-50 dark:hover:bg-fuchsia-950/20',
    border: 'hover:border-fuchsia-300 dark:hover:border-fuchsia-700',
  },
  {
    to: '/pcap-viewer' as const,
    icon: <Activity className="h-8 w-8 text-lime-500" />,
    titleKey: 'communityNext.pcapViewer.title',
    descKey: 'communityNext.pcapViewer.desc',
    tagKeys: [],
  ...
  {
    to: '/heap-snapshot' as const,
    icon: <Activity className="h-8 w-8 text-indigo-500" />,
    titleKey: 'home.tools.communityHeap.title',
    descKey: 'home.tools.communityHeap.desc',
    tagKeys: [],
    gradient: 'hover:bg-indigo-50 dark:hover:bg-indigo-950/20',
    border: 'hover:border-indigo-300 dark:hover:border-indigo-700',
  },
  {
    to: '/chrome-trace' as const,
    icon: <Activity className="h-8 w-8 text-red-500" />,
    titleKey: 'home.tools.communityTrace.title',
    descKey: 'home.tools.communityTrace.desc',
    tagKeys: [],
    gradient: 'hover:bg-red-50 dark:hover:bg-red-950/20',
    border: 'hover:border-red-300 dark:hover:border-red-700',
  },
  {
    to: '/netlog-viewer' as const,
    icon: <Activity className="h-8 w-8 text-teal-500" />,
    titleKey: 'home.tools.communityNetlog.title',
    descKey: 'home.tools.communityNetlog.desc',
    tagKeys: [],
    gradient: 'hover:bg-teal-50 dark:hover:bg-teal-950/20',
    border: 'hover:border-teal-300 dark:hover:border-teal-700',
  },
  {
    to: '/playwright-trace' as const,
    icon: <Activity className="h-8 w-8 text-pink-500" />,
    titleKey: 'home.tools.communityPlaywright.title',
    descKey: 'home.tools.communityPlaywright.desc',
    tagKeys: [],
    gradient: 'hover:bg-pink-50 dark:hover:bg-pink-950/20',
    border: 'hover:border-pink-300 dark:hover:border-pink-700',
  },
  {
    to: '/asyncapi' as const,
    icon: <Activity className="h-8 w-8 text-blue-500" />,
    titleKey: 'home.tools.communityAsyncapi.title',
    descKey: 'home.tools.communityAsyncapi.desc',
    tagKeys: [],
    gradient: 'hover:bg-blue-50 dark:hover:bg-blue-950/20',
    border: 'hover:border-blue-300 dark:hover:border-blue-700',
  },
  {
    ...
    titleKey: 'home.tools.communityCel.title',
    descKey: 'home.tools.communityCel.desc',
    tagKeys: [],
    gradient: 'hover:bg-yellow-50 dark:hover:bg-yellow-950/20',
    border: 'hover:border-yellow-300 dark:hover:border-yellow-700',
  },
  {
    to: '/spdx-expression' as const,
    icon: <Activity className="h-8 w-8 text-purple-500" />,
    titleKey: 'home.tools.communitySpdx.title',
    descKey: 'home.tools.communitySpdx.desc',
    tagKeys: [],
    gradient: 'hover:bg-purple-50 dark:hover:bg-purple-950/20',
    border: 'hover:border-purple-300 dark:hover:border-purple-700',
  },
  {
    to: '/mqtt-packet' as const,
    icon: <Activity className="h-8 w-8 text-sky-500" />,
    titleKey: 'home.tools.communityMqtt.title',
    descKey: 'home.tools.communityMqtt.desc',
    tagKeys: [],
    gradient: 'hover:bg-sky-50 dark:hover:bg-sky-950/20',
    border: 'hover:border-sky-300 dark:hover:border-sky-700',
  },
  {
    to: '/feed-inspector' as const,
    icon: <Activity className="h-8 w-8 text-rose-500" />,
    titleKey: 'home.tools.communityFeed.title',
    descKey: 'home.tools.communityFeed.desc',
    tagKeys: [],
    gradient: 'hover:bg-rose-50 dark:hover:bg-rose-950/20',
    border: 'hover:border-rose-300 dark:hover:border-rose-700',
  },
  {
    to: '/gltf-inspector' as const,
    icon: <Activity className="h-8 w-8 text-amber-500" />,
    titleKey: 'home.tools.communityModel.title',
    descKey: 'home.tools.communityModel.desc',
    tagKeys: [],
    gradient: 'hover:bg-amber-50 dark:hover:bg-amber-950/20',
    border: 'hover:border-amber-300 dark:hover:border-amber-700',
  },
  {
    to: '/browser-capabilities' as const,
    icon: <Activity className="h-8 w-8 text-emerald-500" />,
    titleKey: 'home.tools.communityCapabilities.title',
    descKey: 'home.tools.communityCapabilities.desc',
    tagKeys: [],
    gradient: 'hover:bg-emerald-50 dark:hover:bg-emerald-950/20',
    border: 'hover:border-emerald-300 dark:hover:border-emerald-700',
  },
  {
    to: '/lighthouse-report' as const,
    icon: <Activity className="h-8 w-8 text-violet-500" />,
    titleKey: 'home.tools.lighthouseReport.title',
    descKey: 'home.tools.lighthouseReport.desc',
    tagKeys: [],
    gradient: 'hover:bg-violet-50 dark:hover:bg-violet-950/20',
    border: 'hover:border-violet-300 dark:hover:border-violet-700',
  },
  {
    to: '/otel-viewer' as const,
    icon: <Network className="h-8 w-8 text-orange-500" />,
    titleKey: 'home.tools.otelViewer.title',
    descKey: 'home.tools.otelViewer.desc',
    tagKeys: [],
    gradient: 'hover:bg-orange-50 dark:hover:bg-orange-950/20',
    border: 'hover:border-orange-300 dark:hover:border-orange-700',
  },
  {
    to: '/rrweb-player' as const,
    icon: <Activity className="h-8 w-8 text-cyan-500" />,
    titleKey: 'home.tools.rrwebPlayer.title',
    descKey: 'home.tools.rrwebPlayer.desc',
    tagKeys: [],
    gradient: 'hover:bg-cyan-50 dark:hover:bg-cyan-950/20',
    border: 'hover:border-cyan-300 dark:hover:border-cyan-700',
  },
  {
    to: '/sbom-viewer' as const,
    icon: <ShieldAlert className="h-8 w-8 text-fuchsia-500" />,
    titleKey: 'home.tools.sbomViewer.title',
    descKey: 'home.tools.sbomViewer.desc',
    tagKeys: [],
    gradient: 'hover:bg-fuchsia-50 dark:hover:bg-fuchsia-950/20',
    border: 'hover:border-fuchsia-300 dark:hover:border-fuchsia-700',
  },
  {
    to: '/browser-compat' as const,
    icon: <Globe className="h-8 w-8 text-lime-500" />,
    titleKey: 'home.tools.browserCompat.title',
    descKey: 'home.tools.browserCompat.desc',
    tagKeys: [],
    gradient: 'hover:bg-lime-50 dark:hover:bg-lime-950/20',
    border: 'hover:border-lime-300 dark:hover:border-lime-700',
  },
  {
    ...
    titleKey: 'home.tools.geojson.title',
    descKey: 'home.tools.geojson.desc',
    tagKeys: [],
    gradient: 'hover:bg-indigo-50 dark:hover:bg-indigo-950/20',
    border: 'hover:border-indigo-300 dark:hover:border-indigo-700',
  },
  ...
  {
    to: '/test-report' as const,
    icon: <FileText className="h-8 w-8 text-red-500" />,
    titleKey: 'home.tools.testReport.title',
    descKey: 'home.tools.testReport.desc',
    tagKeys: [],
    gradient: 'hover:bg-red-50 dark:hover:bg-red-950/20',
    border: 'hover:border-red-300 dark:hover:border-red-700',
  },
  ...
  {
    to: '/sarif-viewer' as const,
    icon: <ShieldAlert className="h-8 w-8 text-teal-500" />,
    titleKey: 'home.tools.sarifViewer.title',
    descKey: 'home.tools.sarifViewer.desc',
    tagKeys: [],
    gradient: 'hover:bg-teal-50 dark:hover:bg-teal-950/20',
    border: 'hover:border-teal-300 dark:hover:border-teal-700',
  },
  {
    to: '/graphql-diff' as const,
    icon: <Network className="h-8 w-8 text-pink-500" />,
    titleKey: 'home.tools.graphqlDiff.title',
    descKey: 'home.tools.graphqlDiff.desc',
    tagKeys: [],
    gradient: 'hover:bg-pink-50 dark:hover:bg-pink-950/20',
    border: 'hover:border-pink-300 dark:hover:border-pink-700',
  },
  {
    to: '/cpu-profile' as const,
    icon: <Activity className="h-8 w-8 text-blue-500" />,
    titleKey: 'home.tools.cpuProfile.title',
    descKey: 'home.tools.cpuProfile.desc',
    tagKeys: [],
    gradient: 'hover:bg-blue-50 dark:hover:bg-blue-950/20',
    border: 'hover:border-blue-300 dark:hover:border-blue-700',
  },
  {
    to: '/i18n-checker' as const,
    icon: <Globe className="h-8 w-8 text-yellow-500" />,
    titleKey: 'home.tools.i18nChecker.title',
    descKey: 'home.tools.i18nChecker.desc',
    tagKeys: [],
    gradient: 'hover:bg-yellow-50 dark:hover:bg-yellow-950/20',
    border: 'hover:border-yellow-300 dark:hover:border-yellow-700',
  },
  {
    to: '/table-diff' as const,
    icon: <Table className="h-8 w-8 text-purple-500" />,
    titleKey: 'home.tools.tableDiff.title',
    descKey: 'home.tools.tableDiff.desc',
    tagKeys: [],
    gradient: 'hover:bg-purple-50 dark:hover:bg-purple-950/20',
    border: 'hover:border-purple-300 dark:hover:border-purple-700',
  },
  {
    to: '/data-redactor' as const,
    icon: <ShieldAlert className="h-8 w-8 text-sky-500" />,
    titleKey: 'home.tools.dataRedactor.title',
    descKey: 'home.tools.dataRedactor.desc',
    tagKeys: [],
    gradient: 'hover:bg-sky-50 dark:hover:bg-sky-950/20',
    border: 'hover:border-sky-300 dark:hover:border-sky-700',
  },
  {
    to: '/log-explorer' as const,
    icon: <Activity className="h-8 w-8 text-rose-500" />,
    titleKey: 'home.tools.logExplorer.title',
    descKey: 'home.tools.logExplorer.desc',
    tagKeys: [],
    gradient: 'hover:bg-rose-50 dark:hover:bg-rose-950/20',
    border: 'hover:border-rose-300 dark:hover:border-rose-700',
  },
  {
    to: '/parquet-viewer' as const,
    icon: <Database className="h-8 w-8 text-amber-500" />,
    titleKey: 'home.tools.parquetViewer.title',
    descKey: 'home.tools.parquetViewer.desc',
    tagKeys: [],
    gradient: 'hover:bg-amber-50 dark:hover:bg-amber-950/20',
    border: 'hover:border-amber-300 dark:hover:border-amber-700',
  },
  {
    to: '/mcp-trace' as const,
    icon: <Network className="h-8 w-8 text-emerald-500" />,
    titleKey: 'home.tools.mcpTrace.title',
    descKey: 'home.tools.mcpTrace.desc',
    tagKeys: [],
    gradient: 'hover:bg-emerald-50 dark:hover:bg-emerald-950/20',
    border: 'hover:border-emerald-300 dark:hover:border-emerald-700',
  },
  {
    ...
    titleKey: 'home.tools.ocr.title',
    descKey: 'home.tools.ocr.desc',
    tagKeys: [],
    gradient: 'hover:bg-violet-50 dark:hover:bg-violet-950/20',
    border: 'hover:border-violet-300 dark:hover:border-violet-700',
  },
  ...
  },
  {
    ...
    tagKeys: [
      'home.tools.gitTool.tagIgnore',
      'home.tools.gitTool.tagCommit',
      'home.tools.gitTool.tagLockfile',
    ],
    gradient: 'hover:bg-orange-50 dark:hover:bg-orange-950/20',
    border: 'hover:border-orange-300 dark:hover:border-orange-700',
  },
...
const frontendTools = [
  ...
  },
  {
    ...
    descKey: 'home.tools.designTokens.desc',
    tagKeys: [],
    gradient: 'hover:bg-orange-50 dark:hover:bg-orange-950/20',
    border: 'hover:border-orange-300 dark:hover:border-orange-700',
  },
...
const videoTools = [
  ...
  {
    to: '/streaming-manifest' as const,
    icon: <ListOrdered className="h-8 w-8 text-orange-500" />,
    titleKey: 'home.tools.streamingManifest.title',
    descKey: 'home.tools.streamingManifest.desc',
    tagKeys: [
      'home.tools.streamingManifest.tagHls',
      'home.tools.streamingManifest.tagDash',
    ],
    gradient: 'hover:bg-orange-50 dark:hover:bg-orange-950/20',
    border: 'hover:border-orange-300 dark:hover:border-orange-700',
  },
...
const lifeTools = [
  ...
  ...ANALYSIS_PRODUCTIVITY_TOOLS.map(({ id, icon: Icon, color, key }) => ({
    to: `/${id}` as const,
    icon: <Icon className={`h-8 w-8 ${color}`} />,
    titleKey: `${key}.title`,
  ...
  },
  {
    ...
    titleKey: 'screenshotAnnotator.title',
    descKey: 'screenshotAnnotator.description',
    tagKeys: [],
    gradient: 'hover:bg-blue-50 dark:hover:bg-blue-950/20',
    border: 'hover:border-blue-300 dark:hover:border-blue-700',
  },
  {
    to: '/photo-frame' as const,
    icon: <Frame className="h-8 w-8 text-amber-500" />,
    titleKey: 'photoFrame.title',
    descKey: 'photoFrame.description',
    tagKeys: [],
    gradient: 'hover:bg-amber-50 dark:hover:bg-amber-950/20',
    border: 'hover:border-amber-300 dark:hover:border-amber-700',
  },
  {
    to: '/label-maker' as const,
    icon: <Tags className="h-8 w-8 text-emerald-500" />,
    titleKey: 'labelMaker.title',
    descKey: 'labelMaker.description',
    tagKeys: [],
    gradient: 'hover:bg-emerald-50 dark:hover:bg-emerald-950/20',
    border: 'hover:border-emerald-300 dark:hover:border-emerald-700',
  },
  {
    to: '/resume-builder' as const,
    icon: <ContactRound className="h-8 w-8 text-indigo-500" />,
    titleKey: 'resumeBuilder.title',
    descKey: 'resumeBuilder.description',
    tagKeys: [],
    gradient: 'hover:bg-indigo-50 dark:hover:bg-indigo-950/20',
    border: 'hover:border-indigo-300 dark:hover:border-indigo-700',
  },
  {
    to: '/seating-chart' as const,
    icon: <Armchair className="h-8 w-8 text-teal-500" />,
    titleKey: 'seatingChart.title',
    descKey: 'seatingChart.description',
    tagKeys: [],
    gradient: 'hover:bg-teal-50 dark:hover:bg-teal-950/20',
    border: 'hover:border-teal-300 dark:hover:border-teal-700',
  },
  {
    to: '/math-worksheet' as const,
    icon: <Calculator className="h-8 w-8 text-orange-500" />,
    titleKey: 'mathWorksheet.title',
    descKey: 'mathWorksheet.description',
    tagKeys: [],
    gradient: 'hover:bg-orange-50 dark:hover:bg-orange-950/20',
    border: 'hover:border-orange-300 dark:hover:border-orange-700',
  },
  {
    to: '/pinyin-annotator' as const,
    icon: <Languages className="h-8 w-8 text-sky-500" />,
    titleKey: 'pinyinAnnotator.title',
    descKey: 'pinyinAnnotator.description',
    tagKeys: [],
    gradient: 'hover:bg-sky-50 dark:hover:bg-sky-950/20',
    border: 'hover:border-sky-300 dark:hover:border-sky-700',
  },
  {
    ...
    titleKey: 'kinship.title',
    descKey: 'kinship.description',
    tagKeys: [],
    gradient: 'hover:bg-rose-50 dark:hover:bg-rose-950/20',
    border: 'hover:border-rose-300 dark:hover:border-rose-700',
  },
  {
    to: '/shift-calendar' as const,
    icon: <CalendarDays className="h-8 w-8 text-violet-500" />,
    titleKey: 'shiftCalendar.title',
    descKey: 'shiftCalendar.description',
    tagKeys: [],
    gradient: 'hover:bg-violet-50 dark:hover:bg-violet-950/20',
    border: 'hover:border-violet-300 dark:hover:border-violet-700',
  },
  {
    to: '/bead-pattern' as const,
    icon: <Grid2X2 className="h-8 w-8 text-fuchsia-500" />,
    titleKey: 'beadPattern.title',
    descKey: 'beadPattern.description',
    tagKeys: [],
    gradient: 'hover:bg-fuchsia-50 dark:hover:bg-fuchsia-950/20',
    border: 'hover:border-fuchsia-300 dark:hover:border-fuchsia-700',
  },
  {
    ...
    descKey: 'flashcards.description',
    tagKeys: [],
    gradient: 'hover:bg-cyan-50 dark:hover:bg-cyan-950/20',
    border: 'hover:border-cyan-300 dark:hover:border-cyan-700',
  },
  {
    to: '/packing-list' as const,
    icon: <Backpack className="h-8 w-8 text-lime-500" />,
    titleKey: 'packingList.title',
    descKey: 'packingList.description',
    tagKeys: [],
    gradient: 'hover:bg-lime-50 dark:hover:bg-lime-950/20',
    border: 'hover:border-lime-300 dark:hover:border-lime-700',
  },
  {
    to: '/subscription-tracker' as const,
    icon: <CreditCard className="h-8 w-8 text-purple-500" />,
    titleKey: 'subscriptionTracker.title',
    descKey: 'subscriptionTracker.description',
    tagKeys: [],
    gradient: 'hover:bg-purple-50 dark:hover:bg-purple-950/20',
    border: 'hover:border-purple-300 dark:hover:border-purple-700',
  },
  {
    to: '/home-inventory' as const,
    icon: <PackageOpen className="h-8 w-8 text-green-500" />,
    titleKey: 'homeInventory.title',
    descKey: 'homeInventory.description',
    tagKeys: [],
    gradient: 'hover:bg-green-50 dark:hover:bg-green-950/20',
    border: 'hover:border-green-300 dark:hover:border-green-700',
  },
  {
    to: '/tuner' as const,
    icon: <Music2 className="h-8 w-8 text-yellow-500" />,
    titleKey: 'tuner.title',
    descKey: 'tuner.description',
    tagKeys: [],
    gradient: 'hover:bg-yellow-50 dark:hover:bg-yellow-950/20',
    border: 'hover:border-yellow-300 dark:hover:border-yellow-700',
  },
  {
    to: '/tournament-bracket' as const,
    icon: <Trophy className="h-8 w-8 text-red-500" />,
    titleKey: 'tournamentBracket.title',
    descKey: 'tournamentBracket.description',
    tagKeys: [],
    gradient: 'hover:bg-red-50 dark:hover:bg-red-950/20',
    border: 'hover:border-red-300 dark:hover:border-red-700',
  },
  {
    to: '/decision-matrix' as const,
    icon: <Scale className="h-8 w-8 text-slate-500" />,
    titleKey: 'decisionMatrix.title',
    descKey: 'decisionMatrix.description',
    tagKeys: [],
    gradient: 'hover:bg-slate-50 dark:hover:bg-slate-950/20',
    border: 'hover:border-slate-300 dark:hover:border-slate-700',
  },
  {
    to: '/cut-planner' as const,
    icon: <Scissors className="h-8 w-8 text-pink-500" />,
    titleKey: 'cutPlanner.title',
    descKey: 'cutPlanner.description',
    tagKeys: [],
    gradient: 'hover:bg-pink-50 dark:hover:bg-pink-950/20',
    border: 'hover:border-pink-300 dark:hover:border-pink-700',
  },
  {
    to: '/room-planner' as const,
    icon: <Sofa className="h-8 w-8 text-stone-500" />,
    titleKey: 'roomPlanner.title',
    descKey: 'roomPlanner.description',
    tagKeys: [],
    gradient: 'hover:bg-stone-50 dark:hover:bg-stone-950/20',
    border: 'hover:border-stone-300 dark:hover:border-stone-700',
  },
  {
    to: '/knitting-counter' as const,
    icon: <Tally5 className="h-8 w-8 text-zinc-500" />,
    titleKey: 'knittingCounter.title',
    descKey: 'knittingCounter.description',
    tagKeys: [],
    gradient: 'hover:bg-zinc-50 dark:hover:bg-zinc-950/20',
