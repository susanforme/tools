...
import { MnemonicPanel } from '@/components/recommended-tool-panels';
...
function PasswordPage() {
  ...
  const [tab, setTab] = useQueryParam<'password' | 'mnemonic'>(
    'tab',
    StringParam,
    'password',
  );
