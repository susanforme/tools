      ...
      <Tabs defaultValue="format">
        ...
        <TabsContent value="format" className="space-y-3 mt-4">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Button size="sm" variant="outline" onClick={fmt.clear}>{t('js.clear')}</Button>
          </div>
          <CodePanel input={fmt.input} output={fmt.output} onInputChange={fmt.setInput} error={fmt.error} language="javascript" />
        </TabsContent>
        ...
        <TabsContent value="minify" className="space-y-3 mt-4">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Button size="sm" variant="outline" onClick={min.clear}>{t('js.clear')}</Button>
          </div>
          <CodePanel input={min.input} output={min.output} onInputChange={min.setInput} error={min.error} language="javascript" />
        </TabsContent>
        ...
        <TabsContent value="obfuscate" className="space-y-3 mt-4">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Button size="sm" variant="outline" onClick={obf.clear}>{t('js.clear')}</Button>
          </div>
          <CodePanel input={obf.input} output={obf.output} onInputChange={obf.setInput} error={obf.error} language="javascript" />
        </TabsContent>
      </Tabs>
    </div>
  )
