...
This Bun workspace keeps the web app in `apps/web`. It uses [TanStack Router](https://tanstack.com/router) with file-based routing; routes live in `apps/web/src/routes`.
